...
<style>
    ...
    /* Buttons */
    .stButton > button {
        background: linear-gradient(90deg, #ff4b4b, #ff8c42) !important;
    ...
    [data-testid="stFileUploader"] {
        border: 2px dashed #ff4b4b66 !important;
    ...
    /* Section divider */
    hr { border-color: #ff4b4b33 !important; }
</style>
...
with col_title:
    ...
    st.markdown("**AI-powered** vehicle detection, speed estimation, and violation tracking in real-time.")
with col_anim:
    if lottie_traffic:
